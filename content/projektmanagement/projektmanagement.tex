...
ID  & Risiko                                                                                                                                                                       & Schadens-potenzial (h) & Eintrittswahrschein-lichkeit (\%) & Schaden gewichtet (h) & Gewichtung                          & Präventionsmassnahmen                                                                                                                                                                 & Massnahme bei Eintritt                                                                                                                                        \\
R01 & \begin{tabular}[c]{@{}l@{}}Regelwerk zwischen Updates und Systemen\\ zu komplex\end{tabular}                                                                                 & 40                     & 25\%                              & 10                    & \cellcolor[HTML]{FE0000}Sehr Schwer & \begin{tabular}[c]{@{}l@{}}Klare Anforderungen definieren, Erwartungen des\\ Auftraggebers früh abholen.\end{tabular}                                                                 & \begin{tabular}[c]{@{}l@{}}Schnell reagieren und Auftraggeber\\ kommunizieren, dass der Aufwand zu gross\\ wird. Einschränken der Anforderungen.\end{tabular} \\
R02 & Komplexes Permission-System für Benutzer                                                                                                                                     & 24                     & 25\%                              & 6                     & \cellcolor[HTML]{FD6864}Schwer      & \begin{tabular}[c]{@{}l@{}}In Elaborations-Phase auf Rechtesystem einigen, so\\ dass Machbarkeit gewährleistet ist.\end{tabular}                                                      & \begin{tabular}[c]{@{}l@{}}Wenn möglich: Anforderungen einschränken.\\ Andernfalls Anforderung komplett weglassen.\end{tabular}                               \\
R03 & \begin{tabular}[c]{@{}l@{}}Ruby ist für Umsetzung des Agents resp.\\ Anschluss an apt nicht geeignet\end{tabular}                                                            & 16                     & 25\%                              & 4                     & \cellcolor[HTML]{FFCB2F}Mittel      & So früh wie möglich Eignung von Ruby für Agent überprüfen.                                                                                                                            & \begin{tabular}[c]{@{}l@{}}Python benutzen, wo es bereits ähnliche\\ Projekte gibt.\end{tabular}                                                              \\
R04 & \begin{tabular}[c]{@{}l@{}}apt-Schnittstelle ist nicht so umfangreich wie\\ erwartet, z.B. lässt sich nicht erkennen,\\ welche Updates einen Neustart erfordern\end{tabular} & 4                      & 50\%                              & 2                     & \cellcolor[HTML]{009901}Gering      & Frühzeitiges Abklären des Umfangs der aptSchnittstelle.                                                                                                                               & \begin{tabular}[c]{@{}l@{}}a) Selbst erstellte Schnittstelle einsetzen\\ b) Anpassung der Aufgabe, falls nicht anders\\ lösbar.\end{tabular}                  \\
R05 & Zertifikat-Handling ist komplexer als erwartet                                                                                                                               & 8                      & 10\%                              & 0.8                   & \cellcolor[HTML]{34FF34}Sehr Gering & Machbarkeit früh abklären.                                                                                                                                                            & Spezialisten (HSR: Steffen; nine.ch) anfragen.                                                                                                                \\
R06 & \begin{tabular}[c]{@{}l@{}}Viele gleichzeitige Anfragen bereiten\\ Probleme beim Control-Center (Last)\end{tabular}                                                          & 16                     & 25\%                              & 4                     & \cellcolor[HTML]{009901}Gering      & \begin{tabular}[c]{@{}l@{}}Auslastung einplanen, mit erstem stabilem Prototypen\\ Last-Tests fahren.\end{tabular}                                                                     & Spezialisten (HSR: Steffen; nine.ch) anfragen.                                                                                                                \\
R07 & Auftraggeber mit Umsetzung nicht zufrieden                                                                                                                                   & 24                     & 25\%                              & 6                     & \cellcolor[HTML]{FD6864}Schwer      & \begin{tabular}[c]{@{}l@{}}Use-Cases, Scope und NFAs früh teilen und bestätigen\\ lassen. Regelmässige Meetings mit Statusbesprechung\\ und Planung der nächsten Wochen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}Meeting mit Betreuer und Auftraggeber\\ einberufen.\end{tabular}                                                                  
\end{tabular}
\end{table}
\end{landscape}
