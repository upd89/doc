...
\xxx[im Anhang, hier noch ein Text dazu]

\begin{comment}
    5 Sprints mit Milestones (siehe Projektplan) 
    Detaillierte Beschreibung und Auswertung im Anhang
\end{comment}
...
\xxx[R01 und R02 sind eingetroffen]
