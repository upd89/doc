...
Puppet ist als Open-Source oder als kostenpflichtige Enterprise-Version erhätlich.}
{\begin{itemize}
...
\item Client-Server-Architektur mit \textit{puppetmaster}-Daemon auf jedem Node
\end{itemize}}
